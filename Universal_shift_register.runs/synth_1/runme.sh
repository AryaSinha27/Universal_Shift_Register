...
HD_PWD='C:/Users/arya2/Universal_shift_register/Universal_shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_shift_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source universal_shift_reg.tcl
